...
export default function AboutPage() {
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-[#F7E9D7] to-[#E8C89C] min-h-screen">
        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-[90px] pb-24 space-y-32">
          ...
          {/* Team Section */}
          <section>
            <h2 className="text-4xl font-bold text-[#4B2E1D] mb-10 border-b-4 border-[#B8860B] pb-1 text-center">
              Meet Our Team
            </h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
              <div className="flex flex-col items-center text-center space-y-4 place-items-center">
                ...
                <h3 className="text-xl font-semibold text-[#4B2E1D]">Ravi Perera</h3>
