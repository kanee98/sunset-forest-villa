      ...
      <section className="bg-[#0f172a] px-6 sm:px-12 lg:px-32">
        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-16 pb-32 space-y-24">
          ...
          <section>
            ...
            <SphereViewer src="/rooms/V1R3/pano.jpg" />
          </section>

          {/* Room 1 – Sunset Vista Deluxe */}
          <section className="max-w-4xl mx-auto text-[#F7E9D7] space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              Our Sunset Vista Deluxe room embodies warmth and elegance, offering a queen-sized bed, private balcony with glowing sunset views, and earthy interior tones. With refined touches and all modern conveniences, it’s an ideal escape for couples seeking calm and beauty.
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#F7E9D7]">
              <li>Queen-sized bed with premium linens</li>
              <li>Private balcony with sunset-facing view</li>
