      ...
      <section className="bg-[#0f172a] px-6 sm:px-12 lg:px-32">
        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-16 pb-32 space-y-24">
          ...
          <section>
            ...
            <SphereViewer src="/rooms/V1R2/pano.jpg" />
          </section>

          {/* Room 3 – Starlight Deluxe */}
          <section className="max-w-4xl mx-auto text-[#F7E9D7] space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              Cozy yet elegant, Starlight Deluxe offers a romantic hideaway under the stars. With its queen-sized bed, ambient lighting, and secluded patio space, this room invites rest and reflection, all while providing top-tier amenities.
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#F7E9D7]">
              <li>Queen-sized bed with high-thread-count linens</li>
              <li>Private patio ideal for stargazing</li>
