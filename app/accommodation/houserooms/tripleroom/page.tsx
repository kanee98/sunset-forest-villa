        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-16 pb-32 space-y-24">
          ...
          <section className="max-w-4xl mx-auto text-[#F7E9D7] space-y-6 mt-12">
            ...
            <p className="text-lg leading-relaxed">
              A bright and airy room overlooking the lush garden, perfect for those who enjoy natural light and peaceful surroundings. This room offers a comfortable double bed and access to a private en-suite bathroom with hot water.
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#F7E9D7]">
              <li>Double bed with comfortable linens</li>
              <li>Private en-suite bathroom with hot water</li>
