      ...
      <section className="bg-[#0f172a] px-6 sm:px-12 lg:px-32">
        ...
        <main className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-16 pb-32 space-y-24">
          ...
          <section>
            ...
            <SphereViewer src="/rooms/V2R3/pano.jpg" />
          </section>

          {/* Room 2 – Fern Grove Retreat */}
          <section className="max-w-4xl mx-auto text-[#F7E9D7] space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              Surrounded by greenery, Fern Grove Retreat is a charming room that embraces tranquility and simplicity. A cozy double bed, garden-level windows, and thoughtful design elements highlight natural beauty while delivering all essential amenities.
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#F7E9D7]">
              <li>Double bed with soft linen bedding</li>
              <li>Garden-view seating area</li>
