        ...
        >
          ...
          >
            ...
            <p className="mt-6 text-lg md:text-xl font-light text-white/90 max-w-3xl mx-auto">
              Explore curated experiences tailored for couples, families, and
              day-trippers at Sunset Forest Villa.
            </p>
          </motion.div>
        </section>
                ...
                <div className="relative w-full h-64">
                  <Image
                    ...
                    sizes="(max-width: 768px) 100vw,
                           ...
                           33vw"
                    priority={index < 3} // Preload top row images
                  />
                </div>
                <div className="p-6 space-y-4">
                  <h3 className="text-2xl font-bold text-[#4B2E1D]">
                    {pkg.title}
                  </h3>
